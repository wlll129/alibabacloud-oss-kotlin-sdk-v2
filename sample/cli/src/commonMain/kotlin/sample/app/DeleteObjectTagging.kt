...
// java -jar cli-jvm.jar DeleteObjectTagging --region `region` --bucket `bucket` --key `key`
class DeleteObjectTagging : SampleSubcommand(
    "DeleteObjectTagging",
    ...
    override suspend fun executeCommand() {
        OSSClient.create(ClientConfiguration.loadDefault().apply {
            ...
            val res = client.deleteObjectTagging(DeleteObjectTaggingRequest {
