...
// java -jar cli-jvm.jar GetObjectAcl --region `region` --bucket `bucket` --key `key`
class GetObjectAcl : SampleSubcommand(
    "GetObjectAcl",
    ...
    override suspend fun executeCommand() {
        OSSClient.create(ClientConfiguration.loadDefault().apply {
            ...
            val res = client.getObjectAcl(GetObjectAclRequest {
