...
// java -jar cli-jvm.jar DeleteBucket --region `region` --bucket `bucket`
class DeleteBucket : SampleSubcommand("DeleteBucket", "Deletes a bucket.") {
    ...
    override suspend fun executeCommand() {
        OSSClient.create(ClientConfiguration.loadDefault().apply {
            ...
            val res = client.deleteBucket(DeleteBucketRequest {
