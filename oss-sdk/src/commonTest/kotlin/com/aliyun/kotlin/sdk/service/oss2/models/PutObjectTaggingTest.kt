...
class PutObjectTaggingTest {
    ...
    fun buildRequestFromBuilder() {
        val builder = PutObjectTaggingRequest.Builder()
    ...
    fun buildResultWithEmptyValues() {
        val result = PutObjectTaggingResult {}
    ...
    fun buildResultFromBuilder() {
        val builder = PutObjectTaggingResult.Builder()
        builder.status = "OK"
        ...
        val result = PutObjectTaggingResult(builder)
        assertEquals(200, result.statusCode)
        assertEquals("OK", result.status)
        assertEquals("id-123", result.requestId)
        assertEquals("versionId", result.versionId)
