 ...
 */
public class PutVectorBucketRequest(builder: Builder) : RequestModel(builder) {
    ...
    /**
     * The access control list (ACL) of the vector bucket to be created.
     * Valid values:
     * *   public-read-write
     * *   public-read
     * *   private (default)
     ...
     * *   If you include the header in the request and specify the ID of the resource group, the vector bucket that you create belongs to the resource group. If the specified resource group ID is rg-default-id, the bucket that you create belongs to the default resource group.
    ...
    public inline fun copy(block: Builder.() -> Unit = {}): PutVectorBucketRequest = Builder(this).apply(block).build()

    public companion object Companion {
        public operator fun invoke(builder: Builder.() -> Unit): PutVectorBucketRequest =
    ...
    public class Builder() : RequestModel.Builder() {
        ...
        /**
         * The access control list (ACL) of the vector bucket to be created. Valid values:
         * *   public-read-write
         * *   public-read
        ...
        public fun build(): PutVectorBucketRequest {
            return PutVectorBucketRequest(this)
        }

        public constructor(from: PutVectorBucketRequest) : this() {
