...
import com.aliyun.kotlin.sdk.service.oss2.serialization.xml.deserialization.LexingXmlStreamReader
import com.aliyun.kotlin.sdk.service.oss2.serialization.xml.deserialization.StringTextStream
import com.aliyun.kotlin.sdk.service.oss2.serialization.xml.deserialization.XmlLexer
...
public interface XmlStreamReader {
     ...
     *
     * @throws [DeserializationException] upon any error.
     */
...
internal inline fun <reified TExpected : XmlToken> XmlStreamReader.takeNextAs(): TExpected {
    val token =
        this.nextToken() ?: throw DeserializationException("Expected ${TExpected::class} but instead found null")
