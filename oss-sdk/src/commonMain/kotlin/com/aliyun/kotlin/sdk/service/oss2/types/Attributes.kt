 ...
 */
public data class AttributeKey<T>(val name: String) {
    init {
 ...
 */
public operator fun <T : Any> Attributes.get(key: AttributeKey<T>): T =
    getOrNull(key) ?: throw IllegalStateException("No instance for $key")
